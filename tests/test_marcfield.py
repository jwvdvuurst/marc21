...
@pytest.fixture()
def instance_marc_field():
    tag = '245'
    type = 'd'
    repeatable = True
    description = 'Title Statement'
    field = MarcField(tag=tag, type=type, repeatable=repeatable, description=description)
    yield field
    del field
...
class TestMarcField:
    ...
    def test_create_new_marcfield_with_valid_parameters(self, instance_marc_field):
        # # Given
        # tag = '245'
        # type = 'd'
        # repeatable = True
        ...
        assert field.has_indicators == True
    ...
    def test_create_new_marcfield_with_repeatable_true(self):
        ...
        # Then
        assert field.repeatable == True

        del field


    #  Add a new subfield to a MarcField object with repeatable set to True.
    def test_add_new_subfield_with_repeatable_true(self):
        # Given
        tag = '245'
        type = 'd'
        repeatable = True
    ...
    #  Initializes a new instance of MarcField with mandatory parameters tag and type, and optional parameters repeatable, description, has_indicators, indicators, data, and subfields.
    def test_init_with_mandatory_and_optional_parameters(self):
        ...
        # When
        marc_field = MarcField(tag, type, repeatable, description, has_indicators, indicators, data, subfields)

        # Then
        assert marc_field.tag == tag
        assert marc_field.type == type
    ...
    #  Initializes the tag, type, repeatable, description, has_indicators, indicators, data, and subfields attributes with the values passed as parameters.
    ...
    #  add a new subfield with valid parameters
    def test_add_new_subfield_with_valid_parameters(self):
        # Given
        tag = '245'
        type = 'd'
    ...
    #  add a new subfield with repeatable=True
    def test_add_new_subfield_with_repeatable_true(self):
        # Given
        tag = '245'
        type = 'd'
